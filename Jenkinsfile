            ...
            steps {
                sshagent(credentials: ['ec2-ssh-key']) {
                    ...
                    sh '''
                        ...
                        docker pull satishdd/docker-mysql-nodejs-reactjs-app-api:latest

                        echo "===== Pulling latest Frontend image ====="
                        docker pull satishdd/docker-mysql-nodejs-reactjs-app-frontend:latest
                        ...
                        docker run -d \
                            ...
                            -e DB_NAME=appdb \
                            satishdd/docker-mysql-nodejs-reactjs-app-api:latest
                        ...
                        docker run -d \
                            ...
                            --network three-tier-network \
                            -p 3001:3000 \
                            satishdd/docker-mysql-nodejs-reactjs-app-frontend:latest
